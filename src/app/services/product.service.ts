...
export class ProductService {
  private products: Product[] = [
    // Guitarras
    {
      ...
      discount: 18,
      images: ['/assets/images/guitars/fender-strat-1.jpg', '/assets/images/guitars/fender-strat-2.jpg'],
    ...
    },
    {
      ...
      price: 3299.99,
      images: ['/assets/images/guitars/taylor-814-1.jpg'],
      category: { id: 'guitars', name: 'Guitarras', slug: 'guitarras', icon: 'music_note' },
      brand: 'Taylor',
      inStock: true,
      stockQuantity: 8,
    ...
    // Pianos
    {
      ...
      price: 649.99,
      images: ['/assets/images/pianos/yamaha-p125-1.jpg'],
    ...
    // Baterías
    {
      ...
      discount: 11,
      images: ['/assets/images/drums/pearl-export-1.jpg'],
    ...
    // Bajos
    {
      ...
      price: 1899.99,
      images: ['/assets/images/bass/musicman-stingray-1.jpg'],
